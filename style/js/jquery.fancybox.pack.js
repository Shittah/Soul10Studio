...
(function(C, z, f, r) {
    ...
    f.extend(b, {
        ...
        defaults: {
            ...
            tpl: {
                ...
                image: '<img class="fancybox-image" src="{href}" alt="" /> <a class="picBtn" target="_blank" href="{href}">查看原图</a> ',
        ...
        open: function(a, d) {
            ...
            b.opts = f.extend(!0, {},
            b.defaults, d),
            d.keys !== r && (b.opts.keys = d.keys ? f.extend({},
        ...
        bindEvents: function() {
            var a = b.current,
            d;
            a && (q.bind("orientationchange.fb" + (s ? "": " resize.fb") + (a.autoCenter && !a.locked ? " scroll.fb": ""), b.update), (d = a.keys) && n.bind("keydown.fb",
            function(e) {
                var c = e.which || e.keyCode,
                k = e.target || e.srcElement;
                if (27 === c && b.coming) return ! 1; ! e.ctrlKey && (!e.altKey && !e.shiftKey && !e.metaKey && (!k || !k.type && !f(k).is("[contenteditable]"))) && f.each(d,
                function(d, k) {
                    if (1 < a.group.length && k[c] !== r) return b[d](k[c]),
                    e.preventDefault(),
                    !1;
        ...
        _setDimension: function() {
            ...
            if (h.fitToView) if (g.width(c).height(j), e.width(c + y), a = e.width(), p = e.height(), h.aspectRatio) for (; (a > A || p > r) && (c > m && j > u) && !(19 < d++);) j = Math.max(u, Math.min(v, j - 10)),
            c = l(j * E),
            c < m && (c = m, j = l(c / E)),
            c > n && (c = n, j = l(c / E)),
            g.width(c).height(j),
            ...
            a = e.width(),
            p = e.height();
            else c = Math.max(m, Math.min(c, c - (a - A))),
    ...
    b.helpers.title = {
        ...
        beforeShow: function(a) {
            ...
            if (p(e) && "" !== f.trim(e)) {
                d = f('<div class="fancybox-title fancybox-title-' + c + '-wrap">' + e +"<span>↑→可使用键盘方向键翻页观看↓←</span>"+ "</div>");
                switch (c) {
                case "inside":
                    c = b.skin;
                    break;
    ...
    f.fn.fancybox = function(a) {
        ...
        a = a || {};
        d = a.index || 0; ! c || !1 === a.live ? e.unbind("click.fb-start").bind("click.fb-start", k) : n.undelegate(c, "click.fb-start").delegate(c + ":not('.fancybox-item, .fancybox-nav')", "click.fb-start", k);
